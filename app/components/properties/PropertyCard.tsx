...
export function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <Link href={`/properties/${property.id}`} className="group block bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
      ...
      <div className="relative h-52 bg-slate-100 overflow-hidden">
        ...
        <div className="absolute top-3 right-3">
          <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-black/30 text-white backdrop-blur-sm capitalize">
